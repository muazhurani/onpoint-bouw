...
export type ProjectSource = {
  slug: string;
  /** When true, kept in source data but excluded from listings, routes and sitemap */
  hidden?: boolean;
  cover: string;
...
export function getPublishedProjectSources(): ProjectSource[] {
  return projectSources.filter((project) => !project.hidden);
}
